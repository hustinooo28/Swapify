...
const styles = StyleSheet.create({
  ...
  categories: { paddingHorizontal: Spacing.lg, paddingVertical: Spacing.md, gap: 8 },
  catChip: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: BorderRadius.full, borderWidth: 1 },
